...
const Contact = () => {
  const contacts = [
    {
      ...
      label: "Email",
      value: "info.nasimlabib@gmail.com",
    },
    {
      icon: <Mail className="w-5 h-5" />,
      label: "Alternate Email",
      value: "course.mdnasimhossainlabib@gmail.com",
    },
    {
    ...
    },
    {
      ...
      label: "Education",
      value: "BSC in Computer Engineering",
    },
  ];
      ...
      <div className="max-w-4xl w-full bg-white/90 backdrop-blur-sm shadow-2xl rounded-3xl p-8 relative overflow-hidden border border-white/20">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <p className="text-gray-600 text-lg font-medium">Age: 20 Years</p>
  ...
  onClick={(e) => {
    ...
    window.location.href =
      "https://mail.google.com/mail/?view=cm&fs=1&to=info.nasimlabib@gmail.com";
  }}
...
>
  {/* Animated background */}
  <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-purple-600 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

  {/* Shimmer effect */}
  <div className="pointer-events-none absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/20 to-transparent"></div>
  ...
  <span className="relative z-10 flex items-center justify-center gap-2">
    ...
    Send Email
          ...
          <a
            href="https://wa.me/+8801799603000"
