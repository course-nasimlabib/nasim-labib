            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              {["React", "Node.js", "Python", "JavaScript", "Django"].map(
                (skill, index) => (
                  <span
                    key={skill}
                    className="px-4 py-2 bg-white/70 backdrop-blur-sm border border-blue-200 rounded-full text-sm font-medium text-gray-700 hover:bg-purple-400 transition-all duration-300 cursor-default hover:scale-110"
